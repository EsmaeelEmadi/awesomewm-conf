...
local markup = lain.util.markup
-- local blue   = "#80CCE6"
local space3 = markup.font("JetbrainsMonoNerdFont 3", "")

local mytextclock = wibox.widget.textclock(
    markup("#a89984", space3 .. "%H:%M   " ..
        markup.font("JetbrainsMonoNerdFont 3", " ")))
...
-- Separators
local first = wibox.widget.textbox(markup.font("JetbrainsMonoNerdFont 3", " "))
local spr = wibox.widget.textbox(' ')
local small_spr = wibox.widget.textbox(markup.font("JetbrainsMonoNerdFont 4", " "))
local bar_spr = wibox.widget.textbox(markup.font("JetbrainsMonoNerdFont 3", " ") ..
    markup.fontfg(theme.font, _fgColor, "/") ..
    markup.font("JetbrainsMonoNerdFont 5", " "))
...
function theme.at_screen_connect(s)
    ...
    s.mypromptbox = awful.widget.prompt({ prompt = " Run : ", bg = nil })

...
awful.util.tagnames = {"main", "chrome", "opera", "terminal"}
...
-- TODO: add it later
    ...
    switcher.switch(-1, "Mod1", "Alt_L", "Shift", "Tab")
end), awful.key({modkey}, "j", function() awful.client.focus.byidx(-1) end,
...
--     --     preset = naughty.config.presets.critical,
--     --     title = "Oops, there were errors during startup!",
--     --     text = tostring(s.workarea.height)
--     -- })
--     s.wwibox.y = s.workarea.height - 30
--     -- if s.index == 1 thejjjjjjjjjjn

--     --     s.wwibox.x = s.workarea.width / 2
--     -- end
--     -- if s.index == 2 then
--     --     s.wwibox.x = 1366 + s.workarea.width / 2
--     -- end
...
-- awful.spawn.with_shell('xrandr --output DVI-D-0 --auto --output DP-1 --auto')
-- awful.spawn.with_shell('xrandr --output HDMI-0 --auto --output DVI-D-0 --mode 1360x768 --auto --left-of HDMI-0')
-- awful.spawn.with_shell('xrandr --output HDMI-1 --auto --output  --output DVI-D-0 --mode 1360x768 --right-of HDMI-1')
-- xrandr --output HDMI-1 --auto --output DVI-D-1 --auto --left-of HDMI-1 --output DP-1 -s 1366X768 --fight-of HDMI-1')

awful.spawn.with_shell('nitrogen --restore')
awful.spawn.with_shell(
    'setxkbmap -model pc104 -layout us,ir -variant qwerty -option grp:alt_shift_toggle')
-- awful.spawn.with_shell('setxkbmap -model pc104 -layout us,ir -variant qwerty -option grp:alt_shift_toggle')
-- awful.spawn.with_shell('setxkbmap -model pc105 -layout us, ir -option grp:alt_shift_toggle')
